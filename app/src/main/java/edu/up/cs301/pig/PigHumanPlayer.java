...
public class PigHumanPlayer extends GameHumanPlayer implements OnClickListener {
    ...
    public void receiveInfo(GameInfo info) {
        ...
        if(info instanceof PigGameState){
            ...
            this.turnTotalTextView.setText(""+((PigGameState) info).getCurrentTotal());
            this.playerScoreTextView.setText("" + ((PigGameState) info).getPlayer0_score());
            this.oppScoreTextView.setText("" + ((PigGameState) info).getPlayer1_score());
            switch (((PigGameState) info).getCurrentDice()){
                case 1:
